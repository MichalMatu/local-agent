...
1. create/update a staging branch from current `local-agent/main` in a separate temporary clone; never mutate the checkout running `agentd.py` while preparing a release;
